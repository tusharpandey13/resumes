...
### Software Development Engineer 2, Authn-SDKs | Auth0 (Okta)
*Primary maintainer of nextjs-auth0 (21M+ monthly downloads, 141% growth in tenure)*
...
### Software Development Engineer 1, B2B-Subscriptions | ZEE5
*Scaling video streaming platform for 65M+ monthly active users*
...
### Forge: AI Development Workflow Engine
*Claude Code, TypeScript, State Machines*
...
### LightRAW: AI-Powered Photo Editing Pipeline
*Claude Code, RawTherapee, Git, Batch Processing*

- Prompt-driven RAW photo editing system: describe edits in plain English, apply across hundreds of files automatically.
- Replaces complex multi-tool workflows (exposure, color grading, noise reduction) with a single conversational interface backed by professional-grade RAW processors.

### OPAL: Real-time Log Analytics (Auth0 Hackathon Finalist)
*ClickHouse, S3, Benthos, Cube.js*
